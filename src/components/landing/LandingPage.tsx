...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F6F5F2] text-[#1E293B] font-sans-ui flex flex-col">
      {/* Top Navbar */}
      <header className="w-full bg-[#1e293b] text-white px-6 py-3 flex items-center justify-between border-b border-slate-800 sticky top-0 z-30 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 via-purple-600 to-amber-500 flex items-center justify-center text-white font-bold shadow-sm">
          ...
          <div>
            <span className="text-sm font-semibold tracking-wide text-slate-100 flex items-center gap-1.5">
              <span>Job</span>
              <span className="text-indigo-400 font-bold">Craft</span>
              <span className="text-xs">💼</span>
              <span className="text-[10px] bg-slate-700 text-slate-300 px-1.5 py-0.5 rounded font-mono ml-1">12 Templates</span>
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {onGoToDashboard && (
            <button
              ...
              className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-semibold px-3.5 py-2 rounded-md border border-slate-700 transition-colors cursor-pointer"
            >
          ...
          <button
            ...
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold px-4 py-2 rounded-md shadow-sm transition-all duration-150 cursor-pointer active:scale-98"
          >
            <span>Create CV</span>
      ...
      {/* Hero Section */}
      <section className="pt-14 pb-12 px-4 max-w-5xl mx-auto text-center">
        {/* Red Eyebrow */}
        <div className="inline-block mb-3">
          <span className="text-xs font-bold tracking-widest text-[#E03A3A] uppercase">
            PROFESSIONAL CV BUILDER
          </span>
        </div>

        {/* Big Serif Heading */}
        <h1 className="text-4xl md:text-5xl lg:text-[54px] font-serif-title font-semibold tracking-tight text-slate-900 leading-[1.15] mb-5">
          Make a professional CV<br />in 3 simple steps
        </h1>

        {/* Subtitle */}
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mx-auto leading-relaxed mb-8 font-normal">
        ...
        <div className="flex items-center justify-center max-w-xl mx-auto mb-9 relative">
          <div className="grid grid-cols-3 w-full gap-4 relative z-10">
            ...
            >
              <div className="w-10 h-10 rounded-full bg-[#1e293b] text-white flex items-center justify-center font-bold text-sm shadow-sm mb-2 ring-4 ring-[#F6F5F2] group-hover:bg-indigo-600 group-hover:scale-105 transition-all">
                1
              </div>
              <span className="text-xs font-medium text-slate-700 text-center group-hover:text-indigo-600">Choose a template</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-slate-700 text-center group-hover:text-indigo-600">Fill in your details</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-slate-700 text-center group-hover:text-indigo-600">Download your CV</span>
            </button>
          </div>

          {/* Connecting line */}
          <div className="absolute top-5 left-1/6 right-1/6 h-[2px] bg-slate-300 -translate-y-1/2 z-0" />
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => onCreateCV(activeTemplateId)}
            className="group inline-flex items-center justify-center gap-3 bg-[#432874] hover:bg-[#351e5e] text-white text-base font-semibold px-8 py-3.5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer active:scale-98"
          >
            <span>Create CV</span>
      ...
      <section id="template-section" className="py-10 max-w-7xl mx-auto w-full scroll-mt-20">
        <div className="text-center px-4 mb-4">
          <h2 className="text-3xl md:text-4xl font-serif-title font-semibold text-slate-900">
              ...
              return (
                <button
                  ...
                  className={`bg-white rounded-xl border text-left p-2.5 transition-all duration-200 cursor-pointer group flex flex-col justify-between relative ${
                    isSelected
                      ? 'border-indigo-600 ring-2 ring-indigo-600 shadow-md scale-[1.02]'
        ...
        <div className="bg-[#EFECE6] rounded-2xl p-6 md:p-10 border border-[#E2DED6] shadow-sm mx-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* Left Column: Template Information & Actions */}
            <div className="lg:col-span-5 space-y-5">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="bg-[#1e293b] text-white text-[10px] font-bold tracking-wider px-2.5 py-1 rounded-full uppercase">
              ...
              <h3 className="text-3xl md:text-4xl font-serif-title font-semibold text-slate-900">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button
                  ...
                  className="flex-1 bg-[#432874] hover:bg-[#351e5e] text-white text-sm font-semibold px-6 py-3 rounded-lg shadow-sm hover:shadow transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
                >
            ...
            <div className="lg:col-span-7">
              <div className="relative group">
                ...
                >
                  <span className="bg-[#1e293b] text-white text-xs font-semibold px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
      ...
      <footer className="mt-auto border-t border-slate-200 py-6 text-center text-xs text-slate-500">
        <p>© 2026 JobCraft CV Builder. Built for professional career excellence.</p>
      </footer>
    </div>
  );
};

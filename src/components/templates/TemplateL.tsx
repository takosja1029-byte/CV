      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-5 bg-[#0f172a] text-white p-6 space-y-5">
          ...
          <div className="space-y-2">
            <h2 className="text-xs font-bold uppercase tracking-wider text-orange-400 border-b border-slate-700 pb-1">
              CONTACT
            </h2>
        ...
        <div className="col-span-7 p-7 space-y-6">
          ...
          {personal.summary && (
            <div className="space-y-1">
              <h2 className="text-xs font-bold uppercase tracking-wider text-slate-900 border-b-2 border-orange-500 pb-0.5">
                PROFILE
              </h2>
